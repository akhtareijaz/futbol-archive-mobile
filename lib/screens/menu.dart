...
class MyHomePage extends StatelessWidget {
  ...
  final String nama = "Akhtar Eijaz Putranto"; //nama
  final String npm = "2406495571"; //npm
  final String kelas = "B"; //kelas

  final List<ItemHomepage> items = [
    ItemHomepage("All Products", Icons.store_rounded, Colors.blue),
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Selamat datang di Futbol Archive',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18.0,
                      ),
